...
import (
	...
	"strings"
	TDACola "tp1/Cola"
	Bus "tp1/busquedaBinaria"
	Err "tp1/errores"
	Gen "tp1/generadorListas"
	"tp1/votos"
)
...
func main() {
	...
	partido, errPartido := Gen.PrepararListaPartidos(rutaListas)
	...
	Votantes, err := Gen.PrepararListaVotantes(rutaPadrones)
	...
	for s.Scan() {
		...
		if comandos[0] == "ingresar" {
			...
			posicion := Bus.BusquedaVotante(Votantes, dni, 0, len(Votantes)-1)
